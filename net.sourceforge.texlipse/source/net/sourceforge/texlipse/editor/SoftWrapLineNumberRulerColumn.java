 ...
 * @since 2.0
 */
public class SoftWrapLineNumberRulerColumn extends LineNumberRulerColumn {
	...
	class InternalListener implements IViewportListener, ITextListener {
		...
		public void textChanged(TextEvent event) {
			...
			boolean viewerCompletelyShown = false;
			try { viewerCompletelyShown= isViewerCompletelyShown(); }
			catch (Exception ex) {}
	 ...
	 */
	public SoftWrapLineNumberRulerColumn() {
	}
	...
	private void doubleBufferPaint(GC dest) {
		...
		try {
			...
			// System.err.println(visibleLines.getStartLine() + "->" + visibleLines.getNumberOfLines());
	...
	/**
	 * Return a map of correspondences between real lines and wrapped lines
	 * @param text
	 * @param visibleLines
	 * @return
	 */
